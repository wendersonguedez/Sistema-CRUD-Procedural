...
$server = "127.0.0.1"; // caso o servidor estivesse online, seria inserido o servidor ip. neste caso, usamos o localhost, devido o servidor ser local.
$user = "wendy"; // usuario do sistema SGBD
$passwrd = "caraidigdin"; // esta em branco, pois nao existe senha de acesso. caso exista, colocar entre as aspas.
$bd = "crudProcedural"; // nome da base de dados do sistema
