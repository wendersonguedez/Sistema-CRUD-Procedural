      ...
      <div class="container">
          <div class="row"> <!-- classe para criar uma linha -->
              <div class="col"> <!-- classe para criar uma coluna -->
                <h1>Cadastro</h1>
                <form action="script-edit.php" method="POST"> <!-- atributo action fica responsavel por enviar os dados do form para o arquivo especifico, neste caso o script-cadastro.php -->
                    <div class="mb-2">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="hidden" name="id" value="<?php echo $linha['cod_pessoa']; ?>"> <!-- mandando o id da pessoa de forma escondida, ja que ao passar pelo metodo GET, o id da pessoa fica exposto na URL -->
                    </div> 
                </form>
